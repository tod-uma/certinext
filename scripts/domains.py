...
def build_parser() -> argparse.ArgumentParser:
    ...
    conn.add_argument(
        "--account-number", "--client-id", dest="account_number", required=True, metavar="ACCT",
        help="CertiNext account number / OAuth2 client_id",
    )
    conn.add_argument("--client-secret", required=True, metavar="SECRET", help="OAuth2 client secret")
