...
def _domain(client: MagicMock, data: dict[str, Any]) -> Domain:
...
class TestDomainBadFieldData:
    ...
    def test_extra_unknown_fields_do_not_raise(self, mock_client: MagicMock) -> None:
    ...
    def test_str_with_null_name_does_not_raise(self, mock_client: MagicMock) -> None:
        """str() does not raise when domainName is None."""
        d = _domain(mock_client, {"domainId": "abc", "domainName": None})
        result = str(d)
        assert isinstance(result, str)

    def test_str_with_empty_dict_does_not_raise(self, mock_client: MagicMock) -> None:
        """str() does not raise when all fields are missing."""
        d = _domain(mock_client, {})
        result = str(d)
        assert isinstance(result, str)

    def test_repr_with_empty_dict_does_not_raise(self, mock_client: MagicMock) -> None:
        """repr() does not raise when all fields are missing."""
        d = _domain(mock_client, {})
        result = repr(d)
        assert result.startswith("Domain(")

    def test_to_row_with_missing_fields_returns_empty_strings(self, mock_client: MagicMock) -> None:
        """to_row() returns empty strings for all missing fields."""
        d = _domain(mock_client, {})
        row = d.to_row()
        assert all(v == "" for v in row.values())

    def test_to_row_with_null_name_returns_empty_string(self, mock_client: MagicMock) -> None:
        """to_row() converts a null name to an empty string."""
        d = _domain(mock_client, {"domainName": None})
        assert d.to_row()["name"] == ""

    def test_as_dict_returns_raw_data_including_unknown_fields(self, mock_client: MagicMock) -> None:
...
class TestDomainBadDataFixture:
    ...
    def test_all_bad_entries_construct_without_raising(
        self, mock_client: MagicMock, bad_domain_data: list[dict[str, Any]]
    ) -> None:
...
class TestAuthErrorMessages:
    ...
    def test_non_json_error_message_includes_body_excerpt(self) -> None:
...
class TestClientHTTPErrors:
    ...
    def test_get_raises_on_401(self) -> None:
    ...
    def test_get_raises_on_403(self) -> None:
    ...
    def test_get_raises_on_500(self) -> None:
    ...
    def test_post_raises_on_422(self) -> None:
...
class TestDcvMethodValidation:
    ...
    def test_get_dcv_accepts_dns_txt(self, mock_client: MagicMock) -> None:
    ...
    def test_get_dcv_accepts_http_url(self, mock_client: MagicMock) -> None:
    ...
    def test_change_dcv_method_accepts_dns_txt(self, mock_client: MagicMock) -> None:
    ...
    def test_change_dcv_method_accepts_lowercase(self, mock_client: MagicMock) -> None:
    ...
    def test_change_dcv_method_raises_on_dns(self, mock_client: MagicMock) -> None:
    ...
    def test_change_dcv_method_raises_on_unknown_value(self, mock_client: MagicMock) -> None:
    ...
    def test_change_dcv_method_raises_before_api_call(self, mock_client: MagicMock) -> None:
    ...
    def test_valid_dcv_methods_constant_contains_expected_values(self) -> None:
...
def _make_rfc7807_response(status_code: int, body: dict[str, Any], headers: dict[str, Any] | None = None) -> MagicMock:
...
class TestTypedExceptionDispatch:
    ...
    def test_404_is_also_certinext_api_error(self) -> None:
    ...
    def test_409_conflict_error_exposes_existing_domain_id(self) -> None:
    ...
    def test_409_conflict_error_existing_domain_id_none_when_absent(self) -> None:
    ...
    def test_429_rate_limit_error_parses_retry_after(self) -> None:
    ...
    def test_429_rate_limit_error_retry_after_none_when_header_absent(self) -> None:
    ...
    def test_other_status_raises_base_certinext_api_error(self) -> None:
...
class TestCertiNextAPIErrorProperties:
    ...
    def test_str_extracts_detail_from_rfc7807_body(self) -> None:
    ...
    def test_str_falls_back_to_title_when_detail_absent(self) -> None:
    ...
    def test_str_falls_back_to_full_body_when_neither_detail_nor_title(self) -> None:
    ...
    def test_str_with_plain_text_body(self) -> None:
    ...
    def test_ems_code_extracted_from_detail(self) -> None:
    ...
    def test_ems_code_extracted_from_domain_detail(self) -> None:
    ...
    def test_ems_code_falls_back_to_type_url(self) -> None:
    ...
    def test_ems_code_none_when_absent(self) -> None:
    ...
    def test_ems_code_none_when_body_is_string(self) -> None:
        """ems_code returns None when the body is raw text."""
        err = CertiNextAPIError(500, "Internal Server Error")
        assert err.ems_code is None

    def test_field_errors_returns_errors_array(self) -> None:
