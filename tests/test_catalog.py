...
class TestCatalogAccessorListProducts:
    ...
    def test_calls_products_endpoint(self):
    ...
    def test_returns_list_of_product_categories(self):
    ...
    def test_categories_contain_products(self):
...
class TestCatalogAccessorGetCustomFields:
    ...
    def test_calls_custom_fields_endpoint(self):
    ...
    def test_returns_custom_fields_from_list_response(self):
    ...
    def test_returns_custom_fields_from_wrapped_response(self):
